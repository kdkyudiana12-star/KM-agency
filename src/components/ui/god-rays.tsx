...
// ("God Rays"). Zero dependencies: one WebGL canvas that fills its
...
vec3 shade(vec2 uv, vec2 p, float t) {
  ...
  float noise = fbm(vec2(angle * density * 0.16 + u_seed, radius * 1.7 - t * 0.08));
  float rays = pow(max(0.0, sin(angle * density + noise * 5.0 + t * 0.16)), 5.0);
...
const UNIFORMS = {
  // Retuned to the Kreetiv Media brand palette: void -> graphite -> gold.
  colors: [[0.039,0.039,0.039],[0.239,0.184,0.078],[0.784,0.663,0.416],[0.961,0.953,0.933],[0.961,0.953,0.933],[0.961,0.953,0.933],[0.961,0.953,0.933],[0.961,0.953,0.933]] as [number, number, number][],
  colorCount: 4,
  scale: 1.260,
  intensity: 0.350,
  paramA: 0.280,
